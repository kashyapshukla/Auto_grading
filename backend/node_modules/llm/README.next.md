...
```
git clone https://github.com/snwfdhmp/tc
cd tc
yarn install
```
...
```
$ tc "Hello world"
$ tc -m bing-creative "Tell me a joke"
$ tc -m gpt-3.5-turbo "Tell me a joke"
```
...
```
$ tc "what is the meaning of life?"
```

> Use a specific model

```
$ tc -m bing-creative "find project ideas to learn react"
```

> Use custom parameters

```
$ tc --max-length 512 --temperature 1 --top-p 0.9 --top-k 60 "follow the instructions."
```
...
```
$ tc -s session_name "what is the meaning of life?"
remembers past messages
$ tc --install github.com/snwfhdmp/tc-descriptor-llama
downloads model from github
```

## Add any model

Any model can be plugged into `tc` using a model descriptor.

**Example of a model descriptor which requires installation**

```yaml
kind: tc/descriptor/v1
metadata:
    name: llama
model:
    install: |
...
These variables can be used to tweak `tc` behavior.
